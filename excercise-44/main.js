...
function sandwiches(ingre) {
    let ingredients = ingre;
    console.log("/n your sandwiches have " + ingredients + " " + " in it");
}
sandwiches(['cheese', 'chicken zinger', 'cabbage', 'sauses']);
sandwiches(['Peanut butter', 'onion ', 'beef patty', 'sauses']);
sandwiches(['chocolate', 'strawberry']);
